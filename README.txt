...
CAMBIO v1.4: la carpeta PDF ya no se recorre ni indexa al seleccionarla. Se guarda sólo el permiso y cada PDF se busca bajo demanda. Esto evita que Android pierda el estado de la base al trabajar con carpetas grandes.
